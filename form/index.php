...
if(isset($_POST['submit'])) {
	...
	if(!isset($hasError)) {
		$emailTo = 'justin@justinpontius.synology.me'; // Put your own email address here
		$body = "Name: $name \n\nEmail: $email \n\nPhone Number: $phone \n\nSubject: $subject \n\nComments:\n $comments";
		$headers = 'From: Brandywine Babies <'.$emailTo.'>' . "\r\n" . 'Reply-To: ' . $email;
...
<body>
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="footer">
        <p>Copyright &copy; Brandywine Babies 2014</p>
      </div>
